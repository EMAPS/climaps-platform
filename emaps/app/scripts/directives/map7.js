...
angular.module('emapsApp')
    .directive('map7', function (fileService) {
        return {
      ...
      link: function postLink(scope, element, attrs) {
          ...
          scope.$watch('d', function(newValue, oldValue){
              if(newValue !== oldValue){
                 ...
                 scope.d = newValue;
                  scope.xindex = scope.data["fieldSet"];
                  scope.yindex = scope.data["fieldSet"];
                  //scope.drawChart(scope.orderby,scope.source,scope.target,scope.filter)
